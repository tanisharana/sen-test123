...
import styles from './ViewScheme.style';
import useFetch from '../../../hook/useFetch';

const ViewScheme = () => {
  const navigation = useNavigation();
  const { data: schemeData, loading, error } = useFetch('http://14.97.24.99:8019/api/PurchasePaint/GetScheme');
